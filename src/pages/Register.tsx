...
const Register = ({ onClose, onSwitchToLogin }: RegisterProps) => {
  ...
  const handleGoogleRegister = async () => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: "Hubo un problema al registrar con Google.",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-center mt-6">
              <Button
                ...
                className="w-full text-[#152B3D] flex items-center justify-center space-x-4 hover:bg-transparent transition duration-300 rounded-md py-3 border border-[#599ACF] bg-transparent"
                disabled={isLoading}
              >
                {isLoading ? (
